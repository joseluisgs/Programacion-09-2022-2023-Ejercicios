package es.sergiomisas.concesionario.routes

import es.sergiomisas.concesionario.controllers.ConcesionarioViewController
...
object RoutesManager {
    ...
    fun initAcercaDeStage() {
        ...
        val stage = Stage()
        stage.title = "Acerca De Concesionario"
        stage.scene = scene
